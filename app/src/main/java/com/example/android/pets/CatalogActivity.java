...
public class CatalogActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        displayDatabaseInfo(); // Displays the information whenever this activity is started.
    }
    ...
    private void insertPet(){
        ...
        /**
         * Creates  a ContentValues values which is a key-value pair
         */
        ...
        /**
         * Inserts the data into SQLite table which takes
         * in the TABLE_NAME, - , ContentValues i.e @param: values
         */
        long newRowId = db.insert(PetsEntry.TABLE_NAME,null,values);
        Log.i("CatlogActivity", "RowId: " + newRowId);
    }
